...
7. [Version Control & Tagging](#7-version-control--tagging)
...
- [ ] Name: `Medical-Provider-Test-Project` (or your project name)
...
**Real Example from AcciLink:**
```markdown
## Description
Create a professional About page that tells AcciLink's story...
...
- [ ] Design matches AcciLink branding
...
```
...
- Used AcciLink design system (navy, sage-green, teal)
...
- Responsive design with AcciLink branding
...
- [ ] **All Team Members:**
  ...
  - [ ] Clone AcciLink repo (if not already)
